...
class Agent():
    def __init__(self, state_size, action_size, random_seed):
        ...
        self.momory = ReplayBuffer(action_size, BUFFER_SIZE, BATCH_SIZE, random_seed)
    ...
    def step(self, state, action, reward, next_state, done, time_step):
        ...
        self.momory.add(state, action, reward, next_state, done)

        if len(self.momory) > BATCH_SIZE and time_step % LEARN_EVERY == 0:
